...
%>
<%= msg %>
<form action='AddtoController' method='post'>
<div>
...
<div>
<label>Result:</label><input type='text' id='third' name='a3' value='<%= ob.getNum3() %>'></input>
</div>
<br><input type='submit' value='click on add'>
</form>
</body>
</html>