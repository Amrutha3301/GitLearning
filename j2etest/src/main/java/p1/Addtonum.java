...
/**
 * Servlet implementation class Addtonum
 */
//@WebServlet("/Addtonum")
public class Addtonum extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//response.getWriter().append("Served at: ").append(request.getContextPath());
		  ...
		  try { 
			out.print("<html><body>");
			out.print("<form action='Addtonum' method='post'>");
			out.print("<br><h1>Addition of two numbers</h1><br><br>");
			...
			out.print("<br><input type='submit' value='click on add'>");
			out.print("</form>");
			out.print("</body></html>");
